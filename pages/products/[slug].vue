...
<div>
    ...
    <div class="max-w-2xl mx-auto lg:max-w-7xl mt-24" v-if="product !== null">
      <!-- Product -->
      <div class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
        ...
        <div class="flex flex-col-reverse">
          ...
          <div class="hidden mt-6 w-full max-w-2xl mx-auto sm:block lg:max-w-none">
            <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" role="tablist">
              <button id="tabs-2-tab-1" class="relative h-24 bg-white rounded-md flex items-center justify-center text-sm font-medium uppercase text-gray-900 dark:text-white cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring focus:ring-offset-4 focus:ring-opacity-50" aria-controls="tabs-2-panel-1" role="tab" type="button">
          ...
          <div class="w-full aspect-w-1 aspect-h-1">
            ...
            <div id="tabs-2-panel-1" aria-labelledby="tabs-2-tab-1" role="tabpanel" tabindex="0">
              ...
              <img :src="product[0].image" alt="Angled front view with bag zipped and handles upright." class="w-full h-full object-center object-cover sm:rounded-lg">
        ...
        <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          <h1 class="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">{{ product[0].title }} </h1>
          ...
          <div class="mt-3">
            ...
            <!-- <p class="text-3xl text-gray-900 dark:text-white">$140</p> -->
              ...
              <span class="text-3xl text-gray-900 dark:text-white" > {{ product[0].price.eur }} €</span>
 ...
 -->
          ...
          <form class="mt-6">
            ...
            <div class="mt-10 flex sm:flex-col1">
              <button type="submit" class="snipcart-add-item max-w-xs flex-1 bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full"
            ...
            :data-item-name="product[0].title"
              ...
              <button type="button" @click="addTodo(p)" class="ml-4 py-3 px-3 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500">
              ...
              <div>
                ...
                <div class="pb-6 prose prose-sm" id="disclosure-1">
                  <ul role="list dark:text-white">
                    <li class="dark:text-white">Multiple strap configurations</li>

                    <li class="dark:text-white">Spacious interior with top zip</li>

                    <li class="dark:text-white">Leather handle and tabs</li>

                    <li class="dark:text-white">Interior dividers</li>

                    <li class="dark:text-white">Stainless strap loops</li>

                    <li class="dark:text-white">Double stitched construction</li>

                    <li class="dark:text-white">Water-resistant</li>
                  </ul>
                </div>
              </div>
...
import { useProducten } from "~/flamewerk/producten";
