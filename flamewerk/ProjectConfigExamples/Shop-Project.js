...
export const useSettings = defineStore("project", {
  state: () => ({
    ...
    layout: 'app',            // (default, web, app, shop, docs )
    layoutnews: 'docs',       // (default, web, app, shop, docs ) ?? Check if hooked
    layoutdocs: 'docs',       // (default, web, app, shop, docs )      

    shopcurrency: 'eur',

    headertype: 'Application',    // Options: Tiny, Minimal, Maximum, Ecommerce, Application
    headerlanguage: true,

    footertype: 'Ecommerce',       // Options: Tiny, Minimal, Maximum
    footerlanguage: true,
